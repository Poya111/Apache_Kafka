...
public class ElasticSearchConsumerFromTwitterIdempotenceMancommitImprove {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            //Using batch file via Bulk in Elasticsearch to improve performance
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                try {
                    ...
                    logger.warn("Skipped" + record.value());
                }
