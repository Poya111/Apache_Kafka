package com.github.hamid.kafkatwitterproject;
...
public class TwitterProducerAPIIdempoteneceHighThrouput {

    Logger logger = LoggerFactory.getLogger(TwitterProducerAPIIdempoteneceHighThrouput.class.getName());

    public TwitterProducerAPIIdempoteneceHighThrouput() {
    }

    public static void main(String[] args) {
        System.out.println("Twitter");
        new TwitterProducerAPIIdempoteneceHighThrouput().run();
    }
    ...
    public Client createTwitterClient(BlockingQueue<String> msgQueue) {
        ...
        List<String> terms = Lists.newArrayList("bitcin", "politics", "sport");
    ...
    public KafkaProducer <String, String> createKafkaProducer(){
        ...
        properties.setProperty(ProducerConfig.MAX_IN_FLIGHT_REQUESTS_PER_CONNECTION, "5"); // for kafka > 0.11 keep 5,
        // for ordering 1 not 5.

        //High Throughput Producer (at the expense of a bit latency and CPU usage)
        properties.setProperty(ProducerConfig.COMPRESSION_TYPE_CONFIG, "snappy");
        properties.setProperty(ProducerConfig.LINGER_MS_CONFIG, "20");// 20ms delay to produce
