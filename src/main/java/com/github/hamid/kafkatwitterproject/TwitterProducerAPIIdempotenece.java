...
public class TwitterProducerAPIIdempotenece {

    Logger logger = LoggerFactory.getLogger(TwitterProducerAPIIdempotenece.class.getName());

    public TwitterProducerAPIIdempotenece() {
    }

    public static void main(String[] args) {
        System.out.println("Twitter");
        new TwitterProducerAPIIdempotenece().run();
    }
